...
1. [[04_MYSQl-后端/01 基础/16 存储过程与函数#2.2.1 不带参数符号|没有参数（无参数无返回）]]
2. [[04_MYSQl-后端/01 基础/16 存储过程与函数#2.2.3 IN|仅仅带 IN 类型（有参数无返回）]]
3. [[04_MYSQl-后端/01 基础/16 存储过程与函数#2.2.2 OUT|仅仅带 OUT 类型（无参数有返 回）]]
4. [[04_MYSQl-后端/01 基础/16 存储过程与函数#2.2.4 IN 和 OUT 联合使用|既带 IN 又带 OUT（有参数有返回）]]
5. [[04_MYSQl-后端/01 基础/16 存储过程与函数#2.2.5 带 INOUT|带 INOUT（有参数有返回）]]
