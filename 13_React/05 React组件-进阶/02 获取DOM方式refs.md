...
- **方式二**：传入一个对象 (<mark class="hltr-cyan">推荐</mark>)
	- 对象是通过 React.createRef() 方式创建出来的； 
	- 使用时获取到创建的对象其中有一个 **current属性就是对应的元素**； 
- **方式三**：传入一个函数 
...
- 这个时候我们可以通过 [](13_React/05%20React组件-进阶/04%20React的高阶组件.md#五、ref转发|React.forwardRef) 
