...
![100%](00_obsidian相关/Excalidraw/React高阶组件增强Propos.md)
...
那么，如果想要获取到函数组件中的某些方法呢？这个时候就需要使用到 hooks 中的 [useRef](13_React/11%20React%20Hooks/05%20useRef和LayoutEffect.md)
