...
- **数组或 [](13_React/05%20React组件-进阶/05%20portals和fragment.md#二、fragment(片段)|fragments)**：使得 render 方法可以返回多个元素。
- **[](13_React/05%20React组件-进阶/05%20portals和fragment.md#一、Portals的使用|Portals)**：可以渲染子节点到不同的 DOM 子树中。
