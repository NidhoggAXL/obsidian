...
**直接通过内容（字符实体），怎么找到这个[字符实体](05_前端基础/01%20HTML%20+%20CSS/02%20字符实体和URL/01_字符实体.md)呢？**
...
**不通过字符实体，使用[伪元素](05_前端基础/01%20HTML%20+%20CSS/04%20CSS属性/10%20伪元素%20pseudo-elements.md)**
