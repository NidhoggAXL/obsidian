...
* 前面知道V8可以嵌入到任何C++应用程序中，无论是Chrome还是Node.is，事实上都是嵌入了V8引擎来执行JavaScript代码;
...
编写的JavaScript代码会经过V8引擎，再通过Node.js的Bindings，将任务放到 **Libuv(链路)** 的事件循环中

libuv(Unicorn Velociraptor-独角伶盗龙)是使用C语言编写的库

libuv提供了**事件循环、文件系统读写、网络 I/O、线程池**等等内容
