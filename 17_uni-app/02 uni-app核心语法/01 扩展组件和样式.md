...
uni-forms组件使用步骤（**类似[[08 Element-Plus集成#四、FormInstance获取表单实例|Element Plus]]的表单组件用法**）：
...
![gh](https://raw.githubusercontent.com/AXLflechazoPN/Obsidian/main/2025/1765349113000052hw2.png)

## 4.1 重写 uni-forms 组件样式

1. 小程序、App直接重写，需要添加 important

2. H5、App和小程序使用：global( selector ) ，需要添加important

3. H5 使用：deep( selector ) ，需要添加important

![gh|500](https://raw.githubusercontent.com/AXLflechazoPN/Obsidian/main/2025/1765352274000jbntv2.png)
