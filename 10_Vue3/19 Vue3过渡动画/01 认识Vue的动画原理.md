...
- React框架本身并没有提供任何动画相关的API，所以在React中使用过渡动画我们需要使用一个第三方库 [react-transition-group](13_React/06%20React过渡动画/01%20React的过渡动画.md)
...
*  [动态组件](10_Vue3/11%20组件化额外知识/03%20动态组件的使用.md)
* 组件根节点
