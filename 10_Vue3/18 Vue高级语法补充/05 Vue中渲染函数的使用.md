...
前面我们讲解过[[10_Vue3/02 Vue基础-模板语法/11 Vue的虚拟DOM#一、认识VNode|VNode]]和[[10_Vue3/02 Vue基础-模板语法/11 Vue的虚拟DOM|VDOM]]的概念： 
...
* 其实更完整的命名是 **createVNode() 函数**，但是为了简便在Vue将之**简化为 h() 函数**；
