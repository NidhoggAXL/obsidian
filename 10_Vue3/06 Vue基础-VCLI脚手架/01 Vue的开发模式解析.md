...
* 代码的高亮； 
* ES6、[[09_前端工程话/01 前端工程化基础/02 JS模块化开发/02 CommonJS和Node|CommonJS]] 的模块化能力； 
* 组件作用域的CSS； 
...
> [!tip]
> 虽然vue默认是集成了less，但是在使用的时候还是需要下载less的[[09_前端工程话/01 前端工程化基础/04 Webpack基本使用/10 Webpack打包Vue#App.vue的打包过程|loader]]
# 三、如何支持SFC
