...
* 当我们传递给一个组件某个属性，但是该属性并<mark class="hltr-cyan">没有定义对应的props或者emits时</mark>，就称之为非Prop的Attribute； 
...
如果我们**不希望组件的根元素继承attribute**，可以在组件中设置 <mark class="hltr-cyan">inheritAttrs: false</mark>
