...
* 参数: `event`
* 修饰符
	* `.stop` - 调用[[03 事件-event对象|stopPropagation]]
	* `.prevent` - 调用[[03 事件-event对象|preventDefault]]
...
**案例**：在 div 标签里面存在一个 button 按钮，当按钮发生点击的时候阻止发生其[[03 事件-event对象|冒泡]]
