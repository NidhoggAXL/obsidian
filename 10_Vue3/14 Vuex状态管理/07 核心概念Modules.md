...
* 为了解决以上问题，**Vuex 允许我们将 store 分割成模块（modules）**； 
...
> 
> - 第一个showName是在index.js里面module里面的名称
> ![gh](https://raw.githubusercontent.com/AXLflechazoPN/Obsidian/main/2024/1748003875000vl9qic.png)
> 
> - 第二个showName是show里面中getters的showName方法
> ![gh|400](https://raw.githubusercontent.com/AXLflechazoPN/Obsidian/main/2024/1748003905000trrnhg.png)


# 四、module修改或派发根组件

如果希望在action中修改root中的state，那么有如下的方式：在 commit 和 dispath 的第三个参数添加根(`{root: true}`)
